...
[![Maven Central (snapshot)](https://img.shields.io/maven-metadata/v?metadataUrl=https%3A%2F%2Fcentral.sonatype.com%2Frepository%2Fmaven-snapshots%2Fcom%2Fio7m%2Fgtyrell%2Fcom.io7m.gtyrell%2Fmaven-metadata.xml&style=flat-square)](https://central.sonatype.com/repository/maven-snapshots/com/io7m/gtyrell/)
[![Codecov](https://img.shields.io/codecov/c/github/io7m-com/gtyrell.svg?style=flat-square)](https://codecov.io/gh/io7m-com/gtyrell)
![Java Version](https://img.shields.io/badge/21-java?label=java&color=e6c35c)

![com.io7m.gtyrell](./src/site/resources/gtyrell.jpg?raw=true)

| JVM | Platform | Status |
|-----|----------|--------|
| OpenJDK (Temurin) Current | Linux | [![Build (OpenJDK (Temurin) Current, Linux)](https://img.shields.io/github/actions/workflow/status/io7m-com/gtyrell/main.linux.temurin.current.yml)](https://www.github.com/io7m-com/gtyrell/actions?query=workflow%3Amain.linux.temurin.current)|
| OpenJDK (Temurin) LTS | Linux | [![Build (OpenJDK (Temurin) LTS, Linux)](https://img.shields.io/github/actions/workflow/status/io7m-com/gtyrell/main.linux.temurin.lts.yml)](https://www.github.com/io7m-com/gtyrell/actions?query=workflow%3Amain.linux.temurin.lts)|
| OpenJDK (Temurin) Current | Windows | [![Build (OpenJDK (Temurin) Current, Windows)](https://img.shields.io/github/actions/workflow/status/io7m-com/gtyrell/main.windows.temurin.current.yml)](https://www.github.com/io7m-com/gtyrell/actions?query=workflow%3Amain.windows.temurin.current)|
| OpenJDK (Temurin) LTS | Windows | [![Build (OpenJDK (Temurin) LTS, Windows)](https://img.shields.io/github/actions/workflow/status/io7m-com/gtyrell/main.windows.temurin.lts.yml)](https://www.github.com/io7m-com/gtyrell/actions?query=workflow%3Amain.windows.temurin.lts)|
...
will now only be available via a read-only mirror at:
  ...
  https://codeberg.org/io7m-com/gtyrell
